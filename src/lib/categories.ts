...
const META: Record<string, Omit<CategoryMeta, "stream">> = {
  "Class 9": {
    ...
    short: "Class 9",
    tagline: "Concept-building tests for Class 9.",
    icon: BookOpen,
  ...
  "Class 10": {
    ...
    short: "Class 10",
    tagline: "Board-style chapter and full tests.",
    icon: BookOpen,
  ...
  "Class 11": {
    ...
    short: "Class 11",
    tagline: "Strong foundation across PCMB.",
    icon: Calculator,
  ...
  "Class 12": {
    ...
    short: "Class 12",
    tagline: "Board-grade full-syllabus tests.",
    icon: GraduationCap,
  ...
  "11th JEE": {
    label: "Class 11 · JEE",
    short: "JEE 11",
    tagline: "Foundation mocks for JEE aspirants.",
    icon: Calculator,
    accent: "from-violet-500 to-fuchsia-600",
  },
  "11th NEET": {
    label: "Class 11 · NEET",
    short: "NEET 11",
    tagline: "Build a strong base for NEET.",
    icon: FlaskConical,
  ...
  "12th JEE": {
    label: "Class 12 · JEE",
    short: "JEE",
    tagline: "Mains + Advanced level PCM mocks.",
    icon: Atom,
  ...
  "Dropper JEE": {
    label: "Dropper · JEE",
    short: "Dropper JEE",
    tagline: "Full-syllabus revision for JEE droppers.",
    icon: Atom,
  ...
  "Dropper NEET": {
    label: "Dropper · NEET",
    short: "Dropper NEET",
    tagline: "Full-syllabus revision for NEET droppers.",
    icon: Microscope,
    accent: "from-emerald-600 to-teal-700",
  },
  "GATE ECE": {
    label: "GATE · Electronics",
    short: "GATE ECE",
    tagline: "Subject-wise GATE practice for ECE.",
    icon: Cpu,
    accent: "from-slate-700 to-slate-900",
  },
  "GATE ME": {
    label: "GATE · Mechanical",
    short: "GATE ME",
    tagline: "Subject-wise GATE practice for ME.",
    icon: Cpu,
